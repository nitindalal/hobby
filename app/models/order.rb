class Order < ActiveRecord::Base
  attr_accessible :destination_id, :preferred_time, :source_id, :user_id, :source, :destination, :order_type_cd, :packages_attributes, :source_type, :destination_type, :order_type
